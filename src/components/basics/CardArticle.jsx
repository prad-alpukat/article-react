...
export default function Card({ post = { id: 0, title: { rendered: "Title" }, excerpt: { rendered: "Content" }, thumbnail: "https://via.placeholder.com/150" } }) {
  return (
    <div className="w-full shadow-xl card bg-base-100">
      <figure>
        <img src={post._embedded['wp:featuredmedia'] ? post._embedded["wp:featuredmedia"][0].source_url : "https://via.placeholder.com/200x150"} alt="Shoes" className='object-cover object-center w-full h-40' />
      </figure>
